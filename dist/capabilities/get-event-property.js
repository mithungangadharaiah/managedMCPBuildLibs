...
export const getEventProperty = {
    ...
    handler: async (args, dtEnv) => {
        ...
        try {
            const response = await axios.get(`${dtEnv.url}/e/${dtEnv.environmentId}/api/v2/eventTypes/${parsed.data.eventType}/properties/${parsed.data.propertyKey}`, {
                headers: {
...
//# sourceMappingURL=get-event-property.js.map