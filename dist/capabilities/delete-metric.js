...
export const deleteMetric = {
    ...
    handler: async (args, dtEnv) => {
        ...
        try {
            const response = await axios.delete(`${dtEnv.url}/e/${dtEnv.environmentId}/api/v2/metrics/${encodeURIComponent(parsed.data.metricId)}`, {
                headers: {
...
//# sourceMappingURL=delete-metric.js.map