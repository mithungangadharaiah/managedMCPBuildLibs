...
export const getMetric = {
    ...
    handler: async (args, dtEnv) => {
        ...
        try {
            const response = await axios.get(`${dtEnv.url}/e/${dtEnv.environmentId}/api/v2/metrics/${encodeURIComponent(parsed.data.metricId)}`, {
                headers: {
...
//# sourceMappingURL=get-metric.js.map