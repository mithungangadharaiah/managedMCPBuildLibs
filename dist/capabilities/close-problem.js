...
export const closeProblem = {
    ...
    handler: async (args, dtEnv) => {
        ...
        try {
            const response = await axios.post(`${dtEnv.url}/e/${dtEnv.environmentId}/api/v2/problems/${parsed.data.problemId}/close`, requestBody, {
                headers: {
...
//# sourceMappingURL=close-problem.js.map