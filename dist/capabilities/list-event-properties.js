...
export const listEventProperties = {
    ...
    handler: async (args, dtEnv) => {
        ...
        try {
            const response = await axios.get(`${dtEnv.url}/e/${dtEnv.environmentId}/api/v2/eventTypes/${parsed.data.eventType}/properties`, {
                headers: {
...
//# sourceMappingURL=list-event-properties.js.map